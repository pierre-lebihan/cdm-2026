...
const tournamentPhaseStyles: Record<MatchTournamentPhase, PhaseStyle> = {
  group: { label: '', color: '#6366f1', multiplier: 1 },
  round_of_16: { label: '16es de finale', color: '#8b5cf6', multiplier: 1 },
  round_of_8: { label: '8es de finale', color: '#a855f7', multiplier: 2 },
  quarter_final: { label: 'Quarts de finale', color: '#d946ef', multiplier: 3 },
  semi_final: { label: 'Demi-finales', color: '#ec4899', multiplier: 5 },
  third_place: { label: '3e place', color: '#f43f5e', multiplier: 7 },
  final: { label: 'Finale', color: '#eab308', multiplier: 10 },
}
